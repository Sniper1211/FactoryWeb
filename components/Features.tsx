...
const features: ServiceFeature[] = [
  {
    title: 'CNC 精密加工',
    description: '配备 DMG Mori 5轴加工中心，加工精度可达 ±0.005mm，适用于复杂几何形状的金属件制造。',
  ...
  {
    title: '注塑成型',
    description: '拥有 50T 至 1000T 的全电动注塑机群，支持双色注塑及嵌件注塑，满足高外观要求。',
    icon: <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.384-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" /></svg>
  },
  {
    title: '自动化组装',
    description: '定制化非标自动化组装线，集成视觉检测系统，确保每一件成品的装配质量一致性。',
  ...
  {
    title: '钣金与焊接',
    description: '配备大功率激光切割及机器人焊接工作站，提供从切割、折弯到焊接的完整钣金服务。',
    icon: <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
  },
  {
    title: '表面处理',
    description: '提供阳极氧化、电镀、喷粉、喷漆等多种表面处理工艺，提升产品耐腐蚀性及美观度。',
    icon: <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" /></svg>
  },
  {
    title: '质量检测',
    description: '蔡司三坐标（CMM）、光谱仪、轮廓仪等高端检测设备，严格执行 IATF 16949 质量管理体系。',
    ...
    <section id="features" className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-brand-600 font-semibold tracking-wide uppercase text-sm mb-2">核心工艺</h2>
          <h3 className="text-3xl md:text-4xl font-bold text-slate-900">先进制造技术</h3>
          <p className="mt-4 text-xl text-slate-600 max-w-3xl mx-auto">我们不断投资于最新的生产设备与技术，以确保为客户提供最具竞争力的解决方案。</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-white rounded-xl p-8 shadow-sm hover:shadow-xl transition-shadow duration-300 border border-slate-100 group">
